...
class Game(ShowBase):
    def __init__(self):
        ...
        self.enemySpawnSound = loader.loadSfx("Audio/Sounds/enemySpawn.ogg")
        ...
        btn = DirectButton(text="Restart",
                           ...
                           scale=0.07,
                           text_font=self.font,
                           clickSound=loader.loadSfx(
                               "Audio/Sounds/UIClick.ogg"),
        ...
        music = loader.loadMusic(
            "Audio/Music/Defending-the-Princess-Haunted.ogg")
        music.setLoop(True)
